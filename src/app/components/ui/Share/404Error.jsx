      ...
      <div className="main_wrapper">
        <div className="main">
          ...
          <div className="tv">
            ...
            <div className="display_div font-PoppinsMedium ">
              <div className="screen_out">
                <div className="screen_out1">
                  <div className="screen">
                    <span className="notfound_text"> Looks like this project took a vacation. 🏖️</span>
                  </div>
